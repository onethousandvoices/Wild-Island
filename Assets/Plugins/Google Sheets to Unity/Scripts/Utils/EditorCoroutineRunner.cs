        ...
        public void Tick()
        {
            if (coroutine != null)
            {
                ...
                if (current != null)
                {
                    ...
                    {
                        UnityWebRequestAsyncOperation webRequest = current as UnityWebRequestAsyncOperation;
                    ...
                    else if (currentType == typeof(EditorCoroutine))
                    {
                        ...
                        EditorCoroutine editorCoroutine = current as EditorCoroutine;
                    ...
                    if (update)
                    {
                        ...
                        if (current != null)
                        {
                            ...
                            else if (currentType == typeof(EditorStatusUpdate))
                            {
                                ...
                                EditorStatusUpdate updateInfo = current as EditorStatusUpdate;
