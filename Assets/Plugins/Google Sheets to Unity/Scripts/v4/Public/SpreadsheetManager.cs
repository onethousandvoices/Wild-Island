    ...
    {      
        ...
        static IEnumerator Read(WWW www, string titleColumn, int titleRow, OnSpreedSheetLoaded callback)
        {
            ...
            try
            {
                ...
                spreadSheet = new GstuSpreadSheet(responce, titleColumn, titleRow);

            } catch (System.Exception e) {
#if UNITY_EDITOR
                throw new System.Exception("Cannot parse response to spreadsheet from " + www.url + "\n" + e + "\n" + www.text);
#else
                throw new System.Exception("Cannot parse response to spreadsheet\n" + e);
#endif
            }
